  ...
  <nav style="background: #9999ff;" class="navbar navbar-static-top">
    <div class="container">
      ...
      <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
        <ul style="color: #9999ff;" class="nav navbar-nav">
        ...
        <form method="POST" class="navbar-form navbar-left" action="search.php">
          <div class="input-group">
              <input style="color: white;" type="text" class="form-control" id="navbar-search-input" name="keyword" placeholder="Search for Product" required>
